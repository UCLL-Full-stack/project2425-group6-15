      ...
      <div className="bg-white px-4 py-2 flex flex-col gap-2 relative rounded-xl w-10/12 max-w-xl min-w-96">
        ...
        {currentStep === 0 && (
          <div className="flex flex-col gap-2">
            <div>
              <label htmlFor="postTitle" className="text-base text-slate-600">
                {t("posts.create.name")}
              </label>
              <input
                ...
                id="postTitle"
                type="text"
                placeholder={t("posts.create.name")}
            ...
            <div>
              ...
              <textarea
                ...
                value={description}
                id="postDescription"
                placeholder={t("posts.create.description")}
        ...
        {currentStep === 1 && (
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-between gap-2">
              <div>
                <label htmlFor="startDate" className="text-base text-slate-600">
                  {t("posts.create.startdate")}
                </label>
                <input
              ...
              <div>
                <label htmlFor="endDate" className="text-base text-slate-600">
                  {t("posts.create.enddate")}
                </label>
                <input
            ...
            <div>
              <label htmlFor="postTime" className="text-base text-slate-600">
                {t("posts.create.time")}
              </label>
              <input
            ...
            <div>
              <label
                ...
                className="text-base text-slate-600"
              >
                {t("posts.create.location")}
              </label>
              <input
                id="postLocation"
                type="text"
                placeholder={t("posts.create.location")}
                className="w-full p-2 border border-gray-300 rounded-lg focus:outline-none text-base"
                value={address}
        ...
        {currentStep === 2 && (
          <div className="flex flex-col gap-2">
            <div>
              <label
                htmlFor="postParticipants"
                className="text-base text-slate-600"
              >
                {t("posts.create.participants")}
              </label>
