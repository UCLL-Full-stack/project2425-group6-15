  ...
  return (
    <div className="fixed left-0 top-0 h-screen w-64 grid grid-rows-[max-content_1fr_max-content] bg-white shadow-md">
      <div className="flex flex-col items-center p-4">
        <h1 className="text-3xl w-fit font-normal text-blue-950">
          <strong className="font-bold">Join</strong>Me
        </h1>
        <h2 className="text-1xl font-normal text-slate-700">{t("admin.panel")}</h2>
      </div>
      ...
      <div className="flex flex-col px-5 gap-1">
        ...
        >
          <Image
            src={
              isSelected("/admin/interests") ? interestsActifImg : interestsImg
            }
            alt=""
            className="w-8 h-8"
          />
      ...
      <div className="flex flex-col">
        <button
          ...
          type="button"
          className={` group w-full flex items-center justify-between gap-2 rounded-lg hover:bg-gray-200 px-2 py-0.5`}
        >
          <Image
            src={logoutImg}
            alt=""
          ...
          />
          <p className={`text-lg text-slate-600  group-hover:text-red-500`}>
            {t("header.logout")}
          </p>
        </button>
      </div>
