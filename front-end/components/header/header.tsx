...
const Header: React.FC = () => {
  ...
  return (
    ...
    <div className="px-4 max-w-xl"></div>
      <button onClick={() => setCreateNewPostPopupOpen(true)} className="text-blue-600 border-2 border-blue-600 rounded-full px-2 mr-5 transition-all duration-300 ease-in-out hover:bg-blue-600 hover:text-white">{t("header.create_meetup")}</button>
